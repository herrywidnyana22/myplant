...
export const CardItem = ({
  ...
  const isNewDuration = !durationOptionData.some(
  ...
  const [loadingButton, setLoadingButton] = useState<typeof status | null>(
    null,
  );
  ...
  const onSwitchChange = async () => {
    const modeValue: CardItemProps["durationMode"] =
      onMode === "TIMER" ? "NO TIMER" : "TIMER";
        ...
        {disabled && (
          <OverlayEffect
            ...
            className="
                    ...
                    "
          >
            <p className="font-semibold text-2xl text-white tracking-widest">
              Terjadwal
            </p>
